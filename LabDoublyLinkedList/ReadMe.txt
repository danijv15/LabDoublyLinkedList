========================================================================
    APLICACIÓN DE CONSOLA: LabDoublyLinkedList Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación LabDoublyLinkedList.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación LabDoublyLinkedList.


LabDoublyLinkedList.vcxproj
...
LabDoublyLinkedList.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado LabDoublyLinkedList.pch y un archivo de tipos precompilados llamado StdAfx.obj.
